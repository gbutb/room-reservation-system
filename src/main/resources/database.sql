...
VALUES (0, 110, STR_TO_DATE('1,6,2020 1,30,0', '%d,%m,%Y %H,%i,%s'),
       ...
       (6, 307, STR_TO_DATE('26,2,2020 1,30,0', '%d,%m,%Y %H,%i,%s'),
        STR_TO_DATE('26,9,2020 2,30,0', '%d,%m,%Y %H,%i,%s'), false, 0),
       (7, 310, STR_TO_DATE('26,2,2020 2,30,0', '%d,%m,%Y %H,%i,%s'),
        STR_TO_DATE('26,9,2020 3,0,0', '%d,%m,%Y %H,%i,%s'), false, 0),
       (8, 400, STR_TO_DATE('26,2,2020 3,30,0', '%d,%m,%Y %H,%i,%s'),
        STR_TO_DATE('26,9,2020 4,30,0', '%d,%m,%Y %H,%i,%s'), false, 0),
       (9, 402, STR_TO_DATE('26,2,2020 4,30,0', '%d,%m,%Y %H,%i,%s'),
        STR_TO_DATE('26,9,2020 22,30,0', '%d,%m,%Y %H,%i,%s'), false, 0),
       (10, 412, STR_TO_DATE('26,2,2020 5,30,0', '%d,%m,%Y %H,%i,%s'),
