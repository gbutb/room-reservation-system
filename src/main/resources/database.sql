...
INSERT INTO room_comments VALUES
...
VALUES (100, 1, 1, true, true, 0, '253.12 488.25 118.13 51.75'),
       ...
       (211, 1, 2, true, true, 0, '870.75 488.25 118.13 51.75'),
       (212, 1, 2, true, true, 0, '991.13 488.25 83.25 51.75'),
       (213, 1, 2, true, true, 0, '1076.63 445.5 75.38 94.5'),
       (214, 1, 2, true, true, 0, '253.12 407.25 118.13 51.75'),
       (215, 1, 2, true, true, 0, '430.87 407.25 118.13 51.75'),
       (216, 1, 2, true, true, 0, '693 407.25 32.63 51.75'),
       (217, 1, 2, true, true, 0, '727.87 407.25 83.25 51.75'),
       (218, 1, 2, true, true, 0, '870.75 407.25 32.62 51.75'),
       (219, 1, 2, true, true, 0, '905.62 407.25 83.25 51.75'),
       (221, 1, 2, true, true, 0, '527.62 257.63 51.75 83.25'),
       (222, 1, 2, true, true, 0, '608.62 257.63 51.75 83.25'),
       (223, 1, 2, true, true, 0, '608.62 200.25 51.75 55.13'),
       (224, 1, 2, true, true, 0, '527.62 114.75 51.75 83.25'),
       ...
       (311, 1, 3, true, true, 0, '905.62 488.25 83.25 51.75'),
       (312, 1, 3, true, true, 0, '991.13 488.25 83.25 51.75'),
       (313, 1, 3, true, true, 0, '1076.63 445.5 75.38 94.5'),
       (314, 1, 3, true, true, 0, '253.12 407.25 32.63 51.75'),
       (315, 1, 3, true, true, 0, '288 407.25 83.25 51.75'),
       (316, 1, 3, true, true, 0, '430.87 407.25 32.63 51.75'),
       (317, 1, 3, true, true, 0, '465.75 407.25 83.25 51.75'),
       (318, 1, 3, true, true, 0, '693 407.25 32.63 51.75'),
       (319, 1, 3, true, true, 0, '727.87 407.25 83.25 51.75'),
       (321, 1, 3, true, true, 0, '870.75 407.25 32.63 51.75'),
       (322, 1, 3, true, true, 0, '905.62 407.25 83.25 51.75'),
       (323, 1, 3, true, true, 0, '527.62 257.63 51.75 83.25'),
       (324, 1, 3, true, true, 0, '608.62 257.63 51.75 83.25'),
       (325, 1, 3, true, true, 0, '608.62 200.25 51.75 55.13'),
       (326, 1, 3, true, true, 0, '527.62 114.75 51.75 83.25'),
       ...
       (411, 1, 4, true, true, 0, '1076.63 445.5 75.38 94.5'),
       (412, 1, 4, true, true, 0, '253.12 407.25 118.13 51.75'),
       (413, 1, 4, true, true, 0, '430.87 407.25 118.13 51.75'),
       (414, 1, 4, true, true, 0, '693 407.25 118.13 51.75'),
       (415, 1, 4, true, true, 0, '870.75 407.25 118.13 51.75'),
       (416, 1, 4, true, true, 0, '527.62 257.63 51.75 83.25'),
       (417, 1, 4, true, true, 0, '608.62 257.63 51.75 83.25'),
       (418, 1, 4, true, true, 0, '608.62 228.94 51.75 26.44'),
       (419, 1, 4, true, true, 0, '608.62 200.25 51.75 26.44'),
       (421, 1, 4, true, true, 0, '527.62 114.75 51.75 83.25'),
