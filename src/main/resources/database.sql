...
INSERT INTO rooms
VALUES (100, 4, 1, true, true, 0, '253.12 488.25 118.13 51.75'),
       (101, 2, 1, true, true, 0, '373.5 488.25 55.13 51.75'),
       (102, 4, 1, true, true, 0, '430.87 488.25 118.13 51.75'),
       (103, 3, 1, true, true, 0, '551.25 488.25 83.25 51.75'),
       (104, 4, 1, true, true, 0, '693 488.25 118.13 51.75'),
       (105, 2, 1, true, true, 0, '813.37 488.25 55.13 51.75'),
       (106, 4, 1, true, true, 0, '870.75 488.25 118.13 51.75'),
       (107, 3, 1, true, true, 0, '991.13 488.25 83.25 51.75'),
       (108, 4, 1, true, true, 0, '1076.63 445.5 75.38 94.5'),
       (109, 4, 1, true, true, 0, '253.12 407.25 118.13 51.75'),
       (110, 4, 1, true, true, 0, '430.87 407.25 118.13 51.75'),
       (111, 4, 1, true, true, 0, '693 407.25 118.13 51.75'),
       (112, 4, 1, true, true, 0, '870.75 407.25 118.13 51.75'),
       (113, 3, 1, true, true, 0, '527.62 257.63 51.75 83.25'),
       (114, 3, 1, true, true, 0, '608.62 257.63 51.75 83.25'),
       (115, 2, 1, true, true, 0, '608.62 200.25 51.75 55.13'),
       (116, 3, 1, true, true, 0, '527.62 114.75 51.75 83.25'),
       (117, 3, 1, true, true, 0, '608.62 114.75 51.75 83.25'),
       (118, 2, 1, true, true, 0, '608.62 57.38 51.75 55.13'),
       ...
       (208, 3, 2, true, true, 0, '727.87 488.25 83.25 51.75'),
       (209, 2, 2, true, true, 0, '813.37 488.25 55.13 51.75'),
       (210, 4, 2, true, true, 0, '870.75 488.25 118.13 51.75'),
       ...
       (216, 3, 2, true, true, 0, '727.87 407.25 83.25 51.75'),
       (217, 1, 2, true, true, 0, '870.75 407.25 32.62 51.75'),
       (218, 3, 2, true, true, 0, '905.62 407.25 83.25 51.75'),
       (219, 3, 2, true, true, 0, '527.62 257.63 51.75 83.25'),
       (220, 3, 2, true, true, 0, '608.62 257.63 51.75 83.25'),
       ...
       (308, 2, 3, true, true, 0, '813.37 488.25 55.13 51.75'),
       (309, 1, 3, true, true, 0, '870.75 488.25 32.63 51.75'),
       (310, 3, 3, true, true, 0, '905.62 488.25 83.25 51.75'),
       (311, 3, 3, true, true, 0, '991.13 488.25 83.25 51.75'),
       (312, 4, 3, true, true, 0, '1076.63 445.5 75.38 94.5'),
       (313, 1, 3, true, true, 0, '253.12 407.25 32.63 51.75'),
       (314, 3, 3, true, true, 0, '288 407.25 83.25 51.75'),
       (315, 1, 3, true, true, 0, '430.87 407.25 32.63 51.75'),
       (316, 3, 3, true, true, 0, '465.75 407.25 83.25 51.75'),
       (317, 1, 3, true, true, 0, '693 407.25 32.63 51.75'),
       (318, 3, 3, true, true, 0, '727.87 407.25 83.25 51.75'),
       ...
       (404, 4, 4, true, true, 0, '430.87 488.25 118.13 51.75'),
       (405, 3, 4, true, true, 0, '551.25 488.25 83.25 51.75'),
       (406, 4, 4, true, true, 0, '693 488.25 118.13 51.75'),
       (407, 2, 4, true, true, 0, '813.37 488.25 55.13 51.75'),
       (408, 4, 4, true, true, 0, '870.75 488.25 118.13 51.75'),
       ...
       (419, 3, 4, true, true, 0, '527.62 114.75 51.75 83.25'),
       (420, 4, 4, true, true, 0, '608.62 114.75 68.63 83.25'),
       (421, 2, 4, true, true, 0, '608.62 57.38 51.75 55.13'),
       (422, 2, 4, true, true, 0, '608.62 0 51.75 55.13');

INSERT INTO reservations
VALUES (0, 200, STR_TO_DATE('9,1,2020 14,30,0', '%d,%m,%Y %H,%i,%s'),
        STR_TO_DATE('9,12,2020 14,30,0', '%d,%m,%Y %H,%i,%s'), false, 0);
